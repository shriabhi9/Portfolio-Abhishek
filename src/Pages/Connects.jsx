    ...
    <div className="relative overflow-hidden w-[full] flex justify-center md:px-20 py-20 px-10 first-color">
      <div className="w-[80%] flex items-start justify-start max-md:flex-wrap md:gap-10 gap-2">
        ...
        <div className="md:w-[70%] w-[240px] duration-500 transition-all">
          <h1 className="text-white md:text-[3rem] text-[1.7rem] mb-4 duration-500 transition-all">
            Let's start a project together
          </h1>
          <form className="flex flex-col gap-8 pt-[4rem] mt-4 mb-4">
            <label className="flex flex-col items-start gap-4">
              <p className="text-white md:text-[2rem] text-[1rem] duration-500 transition-all">What's your name?</p>
              <input
                className="text-white bg-transparent outline-none md:text-[2rem] text-[1rem] mx:text-[8px] duration-500 transition-all"
                type="text"
            ...
            <label className="flex flex-col items-start gap-4">
              <p className="text-white md:text-[2rem] text-[1rem] duration-500 transition-all">What's your email?</p>
              <input
                className="text-white bg-transparent outline-none md:text-[2rem] text-[1rem] duration-500 transition-all"
                type="text"
            ...
            <div className="w-full h-[2px] second-color mt-4 mb-4"></div>
            <label className="flex flex-col items-start gap-4">
              <p className="text-white md:text-[2rem] text-[1rem] duration-500 transition-all">Your message</p>
              <input
                className="text-white bg-transparent outline-none md:text-[2rem] text-[1rem] duration-500 transition-all"
                type="text"
        ...
        <div className="w-[30%] item-start pl-0 flex flex-col gap-3">
          ...
          <div className="flex flex-col items-start gap-2">
            <p className="font-bold text-[#5c626d] md:text-[1rem] text-xs">CONTACT DETAILS</p>
            <button className="flex flex-col items-center transition-all duration-200 hover:scale-95 group gap-1 text-white">
              <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSBpDltpvjQdpndTLLmcrsxpsXNNdJDSfWvDXkMjcNrvlhbzwRFDLWWjPdfQjVWVpVlwHBzg">
                <p className="md:text-[1rem] text-[13px]">shrivastavaabhishek929@gmail.com</p>
              </a>
          ...
          <div className="flex flex-col items-start gap-2">
            <p className=" font-bold text-[#5c626d] md:text-[1rem] text-xs">SOCIALS</p>
            <button
